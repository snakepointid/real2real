...
def multiLayer_conv_strip(inputs,kernel_size,stride_step,conv_layer_num,zero_pad,scope_name,is_training,is_dropout,reuse=None):
...
def strip_conv(inputs,kernel_size,stride_step,zero_pad,scope_name,is_training):
