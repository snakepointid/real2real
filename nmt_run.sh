...
INPUT_FILE=hdfs://namenodefd1v.qss.zzzc.qihoo.net:9000/home/hdp-reader-tag/user/shechanglue/nmt/all
MODEL_FILE=hdfs://namenodefd1v.qss.zzzc.qihoo.net:9000/home/hdp-reader-tag/user/shechanglue/nmt/model/$1
#
...
$HBOX_HOME/bin/hbox-submit \
   ...
   --worker-gpus 1 \
   --boardEnable true \
   --launch-cmd "python real2real/app/nmt.py --restore_path=./model --save_path=$MODEL_FILE" \
